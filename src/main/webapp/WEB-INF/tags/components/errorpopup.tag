<%-- 
    Document   : errorpopup
    Created on : 15-Mar-2023, 13:17:30
    Author     : User
--%>
...
<c:if test="${message != null && !message.isEmpty()}">
    <comp:cornerflyout color="red" displaymessage="${URLDecoder.decode(message, 'UTF-8')}" flyoutid="error" headmessage="Error" icon="fa fa-close"/>
    <script>
